...
=head3 path_translated
  ...
  # PATH_TRANSLATED="/var/www/htdocs/foo/42"
...
header must be set to the size of the input as required by the CGI spec. The
response will be printed to STDOUT as normal.
