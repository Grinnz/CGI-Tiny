...
access to the library installation location, if installed outside the standard
sitelib for that F<perl> (such as with L<local::lib> or L<Carton>).
...
or added in the CGI script such as with L<lib> or L<lib::relative>.
...
L<CGI::Tiny/"auth_type"> and L<CGI::Tiny/"remote_user"> to the CGI script.
