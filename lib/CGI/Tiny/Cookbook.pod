...
L<Apache|https://httpd.apache.org/docs/2.4/howto/auth.html>), preventing access
to the CGI scripts entirely unless authentication succeeds, and passing only
L<AUTH_TYPE|CGI::Tiny/"auth_type"> and L<REMOTE_USER|CGI::Tiny/"remote_user">
to the CGI script upon successful authentication.
